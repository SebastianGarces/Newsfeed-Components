...
const createArticle = objData => {
	...
	articleDateP.textContent = objData.date;
	articleP1.textContent = objData.firstParagraph;
	articleP2.textContent = objData.secondParagraph;
